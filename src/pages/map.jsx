...
const apiKey = "eyJvcmciOiI1YjNjZTM1OTc4NTExMTAwMDFjZjYyNDgiLCJpZCI6Ijc4ZGNlOGU4OTYzZDQ3MTk4MjNkZWU5ZGE3MDc2OTkxIiwiaCI6Im11cm11cjY0In0="; // Replace with your key
...
// ✅ Accept onRouteComplete as a prop
const Map = ({ onRouteComplete }) => {
  ...
  // ✅ Send back start, destination & distance
  if (onRouteComplete) {
    onRouteComplete({
      distance: dist,
      start,
    ...
    getRoute();
  }, [start, end, onRouteComplete]); // added onRouteComplete to dependency array
